...
#include "FibLFSR.h"
void transform(sf::Image& input_image, FibLFSR* fib);  //  NOLINT
int main(int argc, char* argv[]) {
        ...
        sf::RenderWindow window(sf::VideoMode(world.x, world.y),
        "PHOTO MAGIC");
        sf::RenderWindow window2(sf::VideoMode(world.x, world.y),
        "PHOTO MAGIC 2");
...
void transform(sf::Image& input, FibLFSR* fib) {  //  NOLINT
        sf::Color p;
